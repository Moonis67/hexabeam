...
export function Footer(){return <footer className="footer"><div className="container">
 <div className="footer-grid">
  ...
  <div><h4>Company</h4><Link href="/about/">About us</Link><Link href="/contact/">Contact</Link><Link href="/privacy/">Privacy policy</Link><Link href="/terms/">Terms and conditions</Link></div>
